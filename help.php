...
<head>
    ...
    <title>FAQ - Bantuan - Atrace</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <header class="bg-white sticky top-0 z-50 shadow-sm">
        ...
        <nav class="bg-orange-500 text-white text-sm font-semibold">
            <ul class="max-w-7xl mx-auto flex justify-around py-2 px-4 select-none">
                <li><a href="category.php" class="hover:text-gray-200 cursor-pointer transition-colors duration-200">Kategori</a></li>
                <li><a href="seller_page.php" class="hover:text-gray-200 cursor-pointer transition-colors duration-200">Seller</a></li>
                <li><a href="cart.php" class="hover:text-gray-200 cursor-pointer transition-colors duration-200">Keranjang</a></li>
                <li><a href="help.php" class="hover:text-gray-200 cursor-pointer transition-colors duration-200 ">Bantuan</a></li>
                <li><a href="#" class="hover:text-gray-200 cursor-pointer transition-colors duration-200">About Us</a></li>
            </ul>
        </nav>
    </header>

    <!-- Hero Section -->
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 py-16">
        <div class="max-w-4xl mx-auto px-4 text-center">
            <div class="border-2 border-dashed border-orange-600 rounded-lg p-8 bg-white bg-opacity-60">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Ask us anything</h1>
                <p class="text-gray-700 mb-6">Have any questions? We're here to assist you.</p>
                ...
                <div class="max-w-2xl mx-auto">
                    <form class="relative">
                        <input
                            ...
                            class="w-full px-6 py-4 rounded-full border border-gray-300 text-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                        />
                        <button type="submit" class="absolute right-2 top-1/2 -translate-y-1/2 bg-orange-500 text-white px-6 py-2 rounded-full hover:bg-orange-600 transition-colors">
                            Search
                        </button>
                    </form>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Bagaimana cara menggunakan kupon diskon?</h3>
                            <p class="text-gray-600 text-sm">Anda dapat menggunakan kupon diskon dengan memasukkan kode kupon pada halaman checkout. Pastikan kupon masih berlaku dan memenuhi syarat minimum pembelian.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Apa itu free ongkir dan bagaimana cara mendapatkannya?</h3>
                            <p class="text-gray-600 text-sm">Free ongkir adalah gratis biaya pengiriman untuk pembelian dengan minimum tertentu. Biasanya berlaku untuk pembelian di atas Rp 100.000 ke seluruh Indonesia.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Apa saja metode pembayaran yang tersedia?</h3>
                            <p class="text-gray-600 text-sm">Kami menerima berbagai metode pembayaran seperti transfer bank, e-wallet (OVO, GoPay, DANA), kartu kredit, dan COD (Cash on Delivery).</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Berapa lama waktu pengiriman barang?</h3>
                            <p class="text-gray-600 text-sm">Waktu pengiriman bervariasi tergantung lokasi. Untuk area Jabodetabek 1-2 hari kerja, luar Jabodetabek 2-5 hari kerja, dan area terpencil hingga 7 hari kerja.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Bagaimana cara melakukan retur atau pengembalian barang?</h3>
                            <p class="text-gray-600 text-sm">Anda dapat melakukan retur dalam 7 hari setelah barang diterima. Pastikan barang masih dalam kondisi asli dan lengkap dengan kemasan. Hubungi customer service untuk proses retur.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-800 mb-2">Bagaimana cara menghubungi customer service?</h3>
                            <p class="text-gray-600 text-sm">Anda dapat menghubungi customer service melalui live chat di website, email ke support@atrace.com, atau telepon ke (021) 1234-5678 pada jam kerja 08:00-17:00 WIB.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Newsletter Section -->
    <section class="bg-gradient-to-r from-orange-300 to-yellow-300 py-8">
        <div class="max-w-4xl mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="mb-4 md:mb-0">
                    <h3 class="text-xl font-semibold text-white mb-2">Masih ada pertanyaan lain?</h3>
                    <p class="text-orange-100">Kirim pertanyaan Anda dan kami akan membantu Anda dengan senang hati.</p>
                </div>
                <div class="flex space-x-4">
                    <button onclick="window.location.href='contact.php'" class="bg-white text-orange-500 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        Hubungi Kami
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            const faqItems = document.querySelectorAll('.bg-white.rounded-lg.shadow-sm');
