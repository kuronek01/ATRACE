...
<head>
    ...
    <title>Shopping Cart - Atrace</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="px-6 py-4">
                                <div class="grid grid-cols-12 gap-4 items-center">
                                    <div class="col-span-6 flex items-center space-x-4">
                                        <img src="https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=80&h=80&fit=crop" alt="LCD Monitor" class="w-16 h-16 object-cover rounded">
                                        <span class="text-sm text-gray-800">LCD Monitor</span>
                                    </div>
                                    <div class="col-span-2 text-center text-sm">Rp 650.000</div>
                                    <div class="col-span-2 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <button onclick="decreaseQuantity(1)" class="w-8 h-8 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50">-</button>
                                            <input type="number" id="qty-1" value="1" min="1" class="w-12 text-center border border-gray-300 rounded text-sm">
                                            <button onclick="increaseQuantity(1)" class="w-8 h-8 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50">+</button>
                                        </div>
                                    </div>
                                    <div class="col-span-2 text-center text-sm font-medium">Rp 650.000</div>
                                </div>
                            </div>
                            <!-- Item 2 -->
                            <div class="px-6 py-4">
                                <div class="grid grid-cols-12 gap-4 items-center">
                                    <div class="col-span-6 flex items-center space-x-4">
                                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=80&h=80&fit=crop" alt="H1 Gamepad" class="w-16 h-16 object-cover rounded">
                                        <span class="text-sm text-gray-800">H1 Gamepad</span>
                                    </div>
                                    <div class="col-span-2 text-center text-sm">Rp 550.000</div>
                                    <div class="col-span-2 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <button onclick="decreaseQuantity(2)" class="w-8 h-8 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50">-</button>
                                            <input type="number" id="qty-2" value="2" min="1" class="w-12 text-center border border-gray-300 rounded text-sm">
                                            <button onclick="increaseQuantity(2)" class="w-8 h-8 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50">+</button>
                                        </div>
                                    </div>
                                    <div class="col-span-2 text-center text-sm font-medium">Rp 1.100.000</div>
                                </div>
                            </div>
                        </div>
                        <!-- Cart Actions -->
                        <div class="px-6 py-4 bg-gray-50 flex justify-between">
                            <a href="category.html" class="px-6 py-2 border border-gray-300 rounded text-sm hover:bg-gray-50 transition-colors">Return To Shop</a>
                            <button class="px-6 py-2 border border-gray-300 rounded text-sm hover:bg-gray-50 transition-colors">Update Cart</button>
                        </div>
                    </div>
                    <!-- Coupon Section -->
                    <div class="mt-6 bg-white rounded-lg shadow-sm p-6">
                        <div class="flex space-x-4">
                            <input type="text" placeholder="Coupon Code" class="flex-1 px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                            <button class="bg-orange-500 text-white px-6 py-2 rounded hover:bg-orange-600 transition-colors">Apply Coupon</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">Cart Total</h3>
                                            
                        <div class="space-y-3">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">Subtotal:</span>
                                <span class="font-medium">Rp 1.750.000</span>
                            </div>
                        ...
                        <button onclick="window.location.href='checkout.php'" class="w-full bg-orange-500 text-white py-3 rounded mt-6 hover:bg-orange-600 transition-colors">
                            Process to checkout
                        </button>
                    </div>
                </div>
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-6">
                <div class="flex items-center space-x-2">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Just For You</h2>
                </div>
                <button class="px-6 py-2 border border-gray-300 rounded hover:bg-gray-50">See All</button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=200&fit=crop" alt="ASUS FHD Gaming Laptop" class="w-full h-48 object-cover">
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-gray-800 mb-2">ASUS FHD Gaming Laptop</h3>
                        <div class="flex items-center space-x-2 mb-2">
                            <span class="text-orange-500 font-bold">Rp 15.600.000</span>
                            <span class="text-gray-400 line-through text-sm">Rp 24.000.000</span>
                        </div>
                        <div class="flex items-center space-x-1 text-xs mb-3">
                            <span class="text-yellow-400">★★★★★</span>
                            <span class="text-gray-500">(325)</span>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=300&h=200&fit=crop" alt="IPS LCD Gaming Monitor" class="w-full h-48 object-cover">
                        <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                            </svg>
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-gray-800 mb-2">IPS LCD Gaming Monitor</h3>
                        <div class="flex items-center space-x-2 mb-2">
                            <span class="text-orange-500 font-bold">Rp 3.700.000</span>
                        </div>
                        <div class="flex items-center space-x-1 text-xs mb-3">
                            <span class="text-yellow-400">★★★★★</span>
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=300&h=200&fit=crop" alt="HAVIT HV-G92 Gamepad" class="w-full h-48 object-cover">
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-gray-800 mb-2">HAVIT HV-G92 Gamepad</h3>
                        <div class="flex items-center space-x-2 mb-2">
                            <span class="text-orange-500 font-bold">Rp 560.000</span>
                        </div>
                        <div class="flex items-center space-x-1 text-xs mb-3">
                            <span class="text-yellow-400">★★★★★</span>
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=300&h=200&fit=crop" alt="AK-900 Wired Keyboard" class="w-full h-48 object-cover">
                        <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                            </svg>
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-gray-800 mb-2">AK-900 Wired Keyboard</h3>
                        <div class="flex items-center space-x-2 mb-2">
                            <span class="text-orange-500 font-bold">Rp 1.160.000</span>
                        </div>
                        <div class="flex items-center space-x-1 text-xs mb-3">
                            <span class="text-yellow-400">★★★★★</span>
    ...
    <script>
        ...
        function updateCartTotal() {
            ...
            // Update display (you would need to add IDs to the elements to update them)
