...
<head>
    ...
    <title>Checkout Result - Atrace</title>
    ...
    <header class="bg-white sticky top-0 z-50 shadow-sm">
        <div class="flex items-center w-full max-w-7xl mx-auto px-4 py-2 space-x-4">
            ...
            <nav class="flex items-center space-x-5 text-gray-600">
                ...
                <!-- User Icon -->
                <button aria-label="Login" onclick="window.location.href='login.php'" class="hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-400 rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
    ...
    <main class="flex-grow">
        <div class="max-w-7xl mx-auto px-4 py-6">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Transaksi Pembelian Barang Sukses!</h1>
                <p class="text-gray-600">Barang akan segera dikirim dan akan diterima dalam 1 hari</p>
            </div>

            <!-- Transaction Details -->
            <div class="max-w-2xl mx-auto">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-6">Ringkasan Pembelian</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Nama Transaksi</span>
                            <span class="font-medium">1 item</span>
                        </div>
                        
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Waktu Transaksi</span>
                            <span class="font-medium">10 Desember 2024 10:30 WIB</span>
                        </div>
                        
                        <div class="flex justify-between py-2">
                            <span class="text-gray-600">Metode Pembayaran</span>
                            <div class="flex items-center">
                                <span class="font-medium mr-2">Cash</span>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <button onclick="window.location.href='cart.php'" class="w-full bg-orange-500 text-white py-3 rounded hover:bg-orange-600 transition-colors">
                            Kembali
                        </button>
                    </div>
                </div>
