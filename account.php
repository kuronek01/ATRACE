    ...
    <main class="flex-grow">
        <div class="max-w-7xl mx-auto px-4 py-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <span class="text-sm text-gray-600">Welcome! <span class="text-orange-500">Md Rimel</span></span>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <!-- Manage My Account -->
                        <div class="mb-6">
                            <h3 class="font-semibold text-gray-800 mb-3">Manage My Account</h3>
                            <ul class="space-y-2 text-sm">
                                <li><a href="#" class="text-orange-500 hover:text-orange-600">My Profile</a></li>
                                <li><a href="#" class="text-gray-600 hover:text-orange-500">Address Book</a></li>
                                <li><a href="#" class="text-gray-600 hover:text-orange-500">My Payment Options</a></li>
                            </ul>
                        </div>

                        <!-- My Orders -->
                        <div class="mb-6">
                            <h3 class="font-semibold text-gray-800 mb-3">My Orders</h3>
                            <ul class="space-y-2 text-sm">
                                <li><a href="#" class="text-gray-600 hover:text-orange-500">My Returns</a></li>
                                <li><a href="#" class="text-gray-600 hover:text-orange-500">My Cancellations</a></li>
                            </ul>
                        </div>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <h2 class="text-xl font-semibold text-gray-800 mb-6">Edit Your Profile</h2>
                        
                        <form class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">First Name</label>
                                    <input type="text" value="Md" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                                    <input type="text" value="Rimel" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="email" value="rimel1111@gmail.com" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Address</label>
                                    <input type="text" value="Kingston, 5236, United State" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                            </div>

                            <div class="space-y-4">
                                <h3 class="text-lg font-medium text-gray-800">Password Changes</h3>
                                <div>
                                    <input type="password" placeholder="Current Password" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                                <div>
                                    <input type="password" placeholder="New Password" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                                <div>
                                    <input type="password" placeholder="Confirm New Password" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400">
                                </div>
                            </div>

                            <div class="flex justify-end space-x-4">
                                <button onclick="window.location.href='dashboard.php'" type="button" class="px-6 py-2 text-gray-600 hover:text-gray-800">Cancel</button>
                                <button onclick="window.location.href='dashboard.php'" type="submit" class="bg-orange-500 text-white px-6 py-2 rounded hover:bg-orange-600 transition-colors">Save Changes</button>
                            </div>
                        </form>
                    </div>
                </div>
