...
<head>
    ...
    <title>Checkout - HAVIT HV G-92 Gamepad</title>
    ...
    <main class="flex-grow">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <nav class="text-sm text-gray-500">
                ...
                <a href="cart.php" class="hover:text-orange-500">Keranjang</a>
                <span class="mx-2">></span>
        ...
        <div class="max-w-7xl mx-auto px-4 pb-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    <h2 class="text-2xl font-semibold text-gray-900 mb-8">Billing Details</h2>
                                    
                    <form class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">First Name*</label>
                            <input type="text" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Apartment, floor, etc. (optional)</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                                            
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Town/City*</label>
                            <input type="text" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                                            
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Phone Number*</label>
                            <input type="tel" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                                            
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email Address*</label>
                            <input type="email" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                                            
                        <div class="flex items-center">
                            <input type="checkbox" id="save-info" class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded">
                            <label for="save-info" class="ml-2 text-sm text-gray-700">Save this information for faster check-out next time</label>
                        </div>
                    </form>
                </div>
                ...
                <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop" alt="HAVIT HV G-92 Gamepad" class="w-12 h-12 object-cover rounded">
                                    <span class="text-sm text-gray-700">HAVIT HV G-92 Gamepad</span>
                                </div>
                                <span class="text-sm font-medium">Rp650.000</span>
                            </div>
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-medium">Rp 3.145.370</span>
                            </div>
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <!-- Bank Transfer -->
                        <div class="flex items-center">
                            <input type="radio" id="bank" name="payment" value="bank" class="payment-option h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300">
                            <label for="bank" class="ml-3 flex items-center space-x-3 p-3 border border-gray-200 rounded-md cursor-pointer flex-1">
                                <span class="text-sm font-medium">Bank</span>
                                <div class="flex space-x-2 ml-auto">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/2560px-Visa_Inc._logo.svg.png" alt="Visa" class="h-6 w-auto">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/2560px-Mastercard-logo.svg.png" alt="Mastercard" class="h-6 w-auto">
                                </div>
                            </label>
                        </div>
                        ...
                        <!-- Cash on Delivery -->
                        <div class="flex items-center">
                            <input type="radio" id="cod" name="payment" value="cod" class="payment-option h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300">
                            <label for="cod" class="ml-3 p-3 border border-gray-200 rounded-md cursor-pointer flex-1">
                        ...
                        <!-- Gojek -->
                        <div class="flex items-center">
                            <input type="radio" id="gojek" name="payment" value="gojek" class="payment-option h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300">
                            <label for="gojek" class="ml-3 p-3 border border-gray-200 rounded-md cursor-pointer flex-1">
                                <span class="text-sm font-medium">Gojek</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3 mb-6">
                        <input type="text" placeholder="Coupon Code" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        <button class="px-6 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                            Apply Coupon
                        </button>
                    </div>

                    <!-- Place Order Button -->
                    <button onclick="window.location.href='result.php'" class="w-full bg-orange-500 text-white py-3 px-6 rounded-md font-medium hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors">
                        Place Order
                    </button>
                </div>
            </div>
 ...
 <footer class="bg-gray-300 text-white text-sm select-none py-10">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const applyCouponBtn = document.querySelector('button:contains("Apply Coupon")');
            if (applyCouponBtn) {
                applyCouponBtn.addEventListener('click', function() {
                    ...
                    if (couponCode) {
                        ...
                        // Here you would typically validate the coupon and update the total
                    } else {
            ...
            const placeOrderButton = document.querySelector('button:contains("Place Order")');
            if (placeOrderButton) {
