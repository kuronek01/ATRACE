...
<head>
    ...
    <title>Havit HV G-92 Gamepad - Atrace</title>
...
<body class="bg-gray-50">
    ...
    <header class="bg-white sticky top-0 z-50 shadow-sm">
        ...
        <li>
            <a href="seller.php" class="hover:text-gray-200 cursor-pointer transition-colors duration-200">Seller</a>
        </li>
        <li>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <nav class="text-sm text-gray-500 mb-6">
            ...
            <a href="category.html" class="hover:text-orange-500">Kategori</a>
            <span class="mx-2">></span>
            <span class="text-gray-800">HAVIT HV-G-92 Gamepad</span>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg p-8 shadow-sm">
                    <img id="mainImage" src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop" alt="Havit HV G-92 Gamepad" class="w-full h-96 object-contain">
                </div>
                
                <!-- Thumbnail Images -->
                <div class="flex space-x-2">
                    <button onclick="changeImage('https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop')" class="w-20 h-20 bg-white rounded border-2 border-orange-500 p-2">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=80&h=80&fit=crop" alt="Gamepad 1" class="w-full h-full object-contain">
                    </button>
                    <button onclick="changeImage('https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop')" class="w-20 h-20 bg-white rounded border-2 border-gray-200 p-2 hover:border-orange-500">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=80&h=80&fit=crop" alt="Gamepad 2" class="w-full h-full object-contain">
                    </button>
                    <button onclick="changeImage('https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop')" class="w-20 h-20 bg-white rounded border-2 border-gray-200 p-2 hover:border-orange-500">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=80&h=80&fit=crop" alt="Gamepad 3" class="w-full h-full object-contain">
                    </button>
                    <button onclick="changeImage('https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=400&fit=crop')" class="w-20 h-20 bg-white rounded border-2 border-gray-200 p-2 hover:border-orange-500">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=80&h=80&fit=crop" alt="Gamepad 4" class="w-full h-full object-contain">
                    </button>
                    <button class="w-20 h-20 bg-gray-200 rounded border-2 border-gray-200 flex items-center justify-center text-gray-500 hover:border-orange-500">
            ...
            <div class="space-y-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Havit HV G-92 Gamepad</h1>
                    ...
                    <p class="text-3xl font-bold text-gray-900">Rp 3.145.370</p>
                </div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg p-3">
                    <div class="flex items-start space-x-2">
                        <div class="w-4 h-4 bg-red-500 rounded-full mt-0.5 flex-shrink-0"></div>
                        <div>
                            <p class="text-sm font-medium text-red-800">Warning:</p>
                            <p class="text-xs text-red-600">This product can expose you to chemicals including Diisononyl Phthalate.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex space-x-2">
                            <button class="w-8 h-8 border-2 border-orange-500 rounded text-sm font-medium">XS</button>
                            <button class="w-8 h-8 border-2 border-gray-300 rounded text-sm font-medium hover:border-orange-500">S</button>
                            <button class="w-8 h-8 border-2 border-gray-300 rounded text-sm font-medium hover:border-orange-500">M</button>
                            <button class="w-8 h-8 border-2 border-gray-300 rounded text-sm font-medium hover:border-orange-500">L</button>
                            <button class="w-8 h-8 border-2 border-gray-300 rounded text-sm font-medium hover:border-orange-500">XL</button>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center border border-gray-300 rounded">
                            ...
                            <input type="number" id="quantity" value="2" min="1" class="w-16 text-center border-0 focus:outline-none">
                            <button class="px-3 py-2 hover:bg-gray-100" onclick="increaseQuantity()">+</button>
                        </div>
                        <button onclick="window.location.href='checkout.php'" class="flex-1 bg-orange-500 text-white py-3 px-6 rounded hover:bg-orange-600 transition-colors">
                            Buy Now
                        </button>
                                                
                        <button class="p-3 border border-gray-300 rounded hover:bg-gray-50">
            ...
            <div class="space-y-4">
                <div class="flex space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">Great product! The build quality is excellent and it works perfectly with my gaming setup. Highly recommended for serious gamers.</p>
                    </div>
                </div>
                <div class="flex space-x-4">
                    <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?w=40&h=40&fit=crop&crop=face" alt="User" class="w-10 h-10 rounded-full">
                    <div class="flex-1">
                        <div class="flex items-center space-x-2 mb-1">
                        ...
                        <p class="text-sm text-gray-600">Good controller, responsive buttons and comfortable grip. Only minor issue is the battery life could be better.</p>
                    </div>
                </div>
                <div class="flex space-x-4">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face" alt="User" class="w-10 h-10 rounded-full">
                    <div class="flex-1">
                        <div class="flex items-center space-x-2 mb-1">
                            <span class="font-medium text-sm">Mike Johnson</span>
                            <div class="flex text-yellow-400 text-xs">
                                <span>★★★★★</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600">Perfect for gaming! Fast delivery and exactly as described. Will definitely buy from this seller again.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-2 mb-6">
                ...
                <h3 class="text-xl font-semibold text-gray-800">Barang Lainnya</h3>
            </div>
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative mb-3">
                        <img src="https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=200&h=200&fit=crop" alt="AK-300 Wired Keyboard" class="w-full h-32 object-contain">
                        <span class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded">SALE</span>
                        <button class="absolute top-2 right-2 p-1 hover:bg-gray-100 rounded">
                    ...
                    <div class="space-y-2">
                        ...
                        <h4 class="font-medium text-sm text-gray-800 line-clamp-2">AK-300 Wired Keyboard</h4>
                        <div class="flex items-center space-x-1 text-xs">
                ...
                <div class="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative mb-3">
                        <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200&h=200&fit=crop" alt="Headset Original Proy G8 Series" class="w-full h-32 object-contain">
                        <span class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded">SALE</span>
                        <button class="absolute top-2 right-2 p-1 hover:bg-gray-100 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    ...
                    <div class="space-y-2">
                        ...
                        <h4 class="font-medium text-sm text-gray-800 line-clamp-2">Headset / Earphone Original Proy G8 Series</h4>
                        <div class="flex items-center space-x-1 text-xs">
                            <span class="text-yellow-400">★★★★★</span>
                ...
                <div class="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative mb-3">
                        <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=200&h=200&fit=crop" alt="HAVIT HV-G92 Gamepad" class="w-full h-32 object-contain">
                        <span class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded">SALE</span>
                        <button class="absolute top-2 right-2 p-1 hover:bg-gray-100 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    ...
                    <div class="space-y-2">
                        ...
                        <h4 class="font-medium text-sm text-gray-800 line-clamp-2">HAVIT HV-G92 Gamepad</h4>
                        <div class="flex items-center space-x-1 text-xs">
                            <span class="text-yellow-400">★★★★★</span>
                ...
                <div class="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative mb-3">
                        <img src="https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=200&h=200&fit=crop" alt="IPS LCD Gaming Monitor" class="w-full h-32 object-contain">
                        <span class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded">SALE</span>
                        <button class="absolute top-2 right-2 p-1 hover:bg-gray-100 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    ...
                    <div class="space-y-2">
                        ...
                        <h4 class="font-medium text-sm text-gray-800 line-clamp-2">IPS LCD Gaming Monitor</h4>
                        <div class="flex items-center space-x-1 text-xs">
                            <span class="text-yellow-400">★★★★★</span>
                            <span class="text-gray-500">(67)</span>
                        </div>
                        <div class="space-y-1">
                            <p class="font-bold text-orange-500">Rp 3.965.000</p>
                            <p class="text-xs text-gray-400 line-through">Rp 5.000.000</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function changeImage(src) {
            ...
            event.target.closest('button').classList.add('border-orange-500');
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const sizeButtons = document.querySelectorAll('button[class*="w-8 h-8"]');
