...
<body class="bg-[#e3edf4] font-sans text-[#333]">
  ...
  <main class="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center gap-10 px-6 py-12 mb-10">
    ...
    <section aria-label="Login form" class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
      ...
      <!-- Modified text section to match input width -->
      <div class="w-full text-center text-sm text-gray-700 mb-4 flex justify-between items-center px-3">
        <span>Masuk Ke <span class="font-bold text-orange-500">Atrace</span></span>
        <span><a href="register.php" class="text-orange-500 hover:underline font-medium">Daftar</a></span>
      </div>
      
      <form action="dashboard.php" method="POST">
        <label for="email" class="sr-only">NPM atau Email Amikom</label>
        <input
          id="email"
          type="text"
          placeholder="NPM atau Email Amikom"
          ...
          required
        />
        <div class="mb-4 text-center text-xs text-gray-600">Butuh bantuan?</div>
