...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-2xl font-semibold text-gray-800">Wishlist (4)</h1>
            <button class="px-6 py-2 border border-gray-300 rounded hover:bg-gray-50">Move All To Bag</button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300&h=200&fit=crop" alt="Gucci duffle bag" class="w-full h-48 object-cover">
                    ...
                    <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                    </button>
                </div>
                <div class="p-4">
                    <h3 class="font-medium text-gray-800 mb-2">Gucci duffle bag</h3>
                    <div class="flex items-center space-x-2 mb-3">
                        <span class="text-orange-500 font-bold">Rp 960.000</span>
                        <span class="text-gray-400 line-through text-sm">Rp 1.160.000</span>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1549298916-b41d501d3772?w=300&h=200&fit=crop" alt="RGB liquid CPU Cooler" class="w-full h-48 object-cover">
                    <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                ...
                <div class="p-4">
                    <h3 class="font-medium text-gray-800 mb-2">RGB liquid CPU Cooler</h3>
                    <div class="flex items-center space-x-2 mb-3">
                        <span class="text-orange-500 font-bold">Rp 1.960.000</span>
                    </div>
                    <button class="w-full bg-orange-500 text-white py-2 rounded hover:bg-orange-600 transition-colors">
                        Add To Cart
                    </button>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=300&h=200&fit=crop" alt="GP11 Shooter USB Gamepad" class="w-full h-48 object-cover">
                    <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                ...
                <div class="p-4">
                    <h3 class="font-medium text-gray-800 mb-2">GP11 Shooter USB Gamepad</h3>
                    <div class="flex items-center space-x-2 mb-3">
                        <span class="text-orange-500 font-bold">Rp 660.000</span>
                    </div>
                    <button class="w-full bg-orange-500 text-white py-2 rounded hover:bg-orange-600 transition-colors">
                        Add To Cart
                    </button>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=300&h=200&fit=crop" alt="Quilted Satin Jacket" class="w-full h-48 object-cover">
                    <button class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                ...
                <div class="p-4">
                    <h3 class="font-medium text-gray-800 mb-2">Quilted Satin Jacket</h3>
                    <div class="flex items-center space-x-2 mb-3">
                        <span class="text-orange-500 font-bold">Rp 750.000</span>
                    </div>
                    <button class="w-full bg-orange-500 text-white py-2 rounded hover:bg-orange-600 transition-colors">
                        Add To Cart
                    </button>
    ...
    <script>
        ...
        function removeFromWishlist(productId) {
            ...
            // In real app, this would remove the item from the page
        }
